    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="">
          ...
          <div class="clearfix"></div>
          <a href="{{ route('category.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add new category</a>
        </div>
...
$(document).ready(function() { 
    dataTable = $("#dataListing").DataTable( {
        "processing": true,
        "serverSide": true,
        "columns":[{ "title": "Id", "sortable": true}, { "title": "Category Title", "sortable": true},{ "title": "Status", "sortable": false},{ "title": "Actions", "sortable": false}],
        "ajax":{
            url: '{{ url('/admin/category/listDatatable') }}', // json datasource
...
function changeStatus(id, newstatus){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            $('#msgContainer').show().html('<div class="alert alert-success">Category status have been updated successfully!!</div>').fadeOut(5000);
        },
