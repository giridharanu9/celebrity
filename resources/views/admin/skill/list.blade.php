    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="">
          ...
          <div class="clearfix"></div>
          <a href="{{ route('skill.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add new skill</a>
        </div>
...
$(document).ready(function() { 
    dataTable = $("#dataListing").DataTable( {
        "processing": true,
        "serverSide": true,
        "columns":[{ "title": "Id", "sortable": true}, { "title": "Skill Title", "sortable": true},{ "title": "Status", "sortable": false},{ "title": "Actions", "sortable": false}],
        "ajax":{
            url: '{{ url('/admin/skill/listDatatable') }}', // json datasource
...
function changeStatus(id, newstatus){
    ...
    $.ajax({
        url: '{{ url('/admin/skill/changestatus') }}',
        type: 'post',
        ...
        success: function(data){
            ...
            $('#msgContainer').show().html('<div class="alert alert-success">Skill status have been updated successfully!!</div>').fadeOut(5000);
        },
