    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="">
          ...
          <div class="clearfix"></div>
          <a href="{{ route('page.create') }}" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> Add new Page</a>
...
$(document).ready(function() { 
    dataTable = $("#dataListing").DataTable( {
        "processing": true,
        "serverSide": true,
        "columns":[{ "title": "Id", "sortable": true}, { "title": "Name", "sortable": true},{ "title": "Actions", "sortable": false}],
        "ajax":{
            url: '{{ url('/admin/page/listDatatable') }}', // json datasource
