...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Page details update </h2>
          <div class="clearfix"></div>
        </div>
        <div class="x_content">
          <br />
          <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="{{ url('admin/page/'.$pageData->id) }}" enctype="multipart/form-data" files="true">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <input type="text" id="celebrityname" required="required" value="{{ $pageData->name }}" class="form-control col-md-7 col-xs-12" name="name">
          <div class="error">{{ $errors->first('name') }}</div>
                 ...
                 <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="x_panel1">
                    ...
                    <div class="x_content">
                      ...
                      <div id="editor-one" class="editor-wrapper">{{ $pageData->description }}</div>

                      <textarea name="descr" id="descr" data-target="editor-one" style="display:none;">{{ $pageData->description }}</textarea>
            ...
            <div class="form-group">
              <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-31">
