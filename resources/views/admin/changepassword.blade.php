...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="oldpwd">Old Password <span class="required">*</span>
        </label>
        <div class="col-md-6 col-sm-6 col-xs-12">
          ...
          <div class="error">{{ $errors->first('oldpwd') }}</div>
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="newpwd">New password <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="newpwd">New password Confirmation <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
