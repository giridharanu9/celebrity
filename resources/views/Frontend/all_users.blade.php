	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<div class="panel" style="border:1px solid black; height: 230px;">
               		<div class="panel-body text-center">
	                   <a href="{{url('view_users/'.$info->id)}}">
	                   	<img class="img-fluid" src="{{url('/'.$info->profile ?? null)}}" alt="card image" height="150px" width="100%"></p>
	                    <h4 style="color: black;">{{$info->getUser->name}}</h4> </a> 
                	</div>
            	</div>
			</div>
			@endforeach
